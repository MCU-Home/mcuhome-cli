...
"""Message externalization, gettext-style from day one.
...
and translating them would break every consumer.
...
(the library takes the environment as an explicit argument rather than
reading the process itself; the shell is the one place allowed to read
it directly).
"""
